...
if [[ "$BRANCH" = "develop" ]]; then
      ...
      cd /home/carma/
      git clone https://github.com/usdot-fhwa-stol/autoware.ai.git --depth 1 --branch release/grayson_test
      cd /home/carma/.base-image/workspace/src
      git clone --depth 1 --branch release/grayson_test https://github.com/usdot-fhwa-stol/ros1_bridge.git
fi
